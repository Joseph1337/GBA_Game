...
int getRandNumRange(int lowerbound, int upperbound);
# 17 "main.c" 2
# 1 "start.h" 1
# 22 "start.h"
...
void goToGame() {
    (*(volatile unsigned short *)0x4000000) = (1 << 8) | (1 << 9) | (1 << 12);
    DMANow(3, cityscapePal, ((unsigned short *)0x5000000), 256);

    (*(volatile unsigned short *)0x400000A) = (0 << 7) | (1 << 14) | ((1) << 2) | ((30) << 8);
    DMANow(3, cityscapeTiles, &((charblock *)0x6000000)[1], 22752 / 2 );
    DMANow(3, cityscapeMap, &((screenblock *)0x6000000)[30], 4096 / 2);


    (*(volatile unsigned short *)0x4000008) = (0 << 7) | (1 << 14) | ((0) << 2) | ((28) << 8);
    DMANow(3, roadTiles, &((charblock *)0x6000000)[0], 1728 / 2 );
    DMANow(3, roadMap, &((screenblock *)0x6000000)[28], 4096 / 2);
...
void goToPause() {
    ...
    DMANow(3, pausedTiles, &((charblock *)0x6000000)[0], 13920 / 2 );
...
void goToLose() {
    ...
    (*(volatile unsigned short *)0x4000000) = (1 << 8);
    (*(volatile unsigned short *)0x4000008) = (0 << 7) | (0 << 14) | ((0) << 2) | ((28) << 8);
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 13760 / 2 );
...
void goToInstructions() {
    ...
    (*(volatile unsigned short *)0x4000000) = (1 << 8);
    (*(volatile unsigned short *)0x4000008) = (0 << 7) | (0 << 14) | ((0) << 2) | ((28) << 8);
    DMANow(3, instructionsTiles, &((charblock *)0x6000000)[0], 16736 / 2 );
