...
.L109:
	...
	.size	getRandNum, .-getRandNum
	.align	2
	.global	getRandNumRange
	.syntax unified
	.arm
	.fpu softvfp
	.type	getRandNumRange, %function
getRandNumRange:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
...
.L113:
	.word	rand
	.word	__aeabi_idivmod
	.size	getRandNumRange, .-getRandNumRange
	.global	dma
	.global	videoBuffer
	.data
	.align	2
